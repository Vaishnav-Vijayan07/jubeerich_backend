...
exports.addCourse = [
  ...
  async (req, res) => {
    ...
    const { course_name, course_description, course_type_id, stream_id, updated_by } = req.body;
...
exports.updateCourse = [
  ...
  async (req, res) => {
    ...
    try {
      ...
      res.status(200).json({ status: true, message: "Course updated successfully", data: updatedCourse });
    } catch (error) {
